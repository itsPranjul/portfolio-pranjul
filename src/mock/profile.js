export const SOCIAL_LINKS = [
  {
    link: 'https://twitter.com/PalPranjulist',       
  ...
  {
    link: 'https://linkedin.com/in/pranjul-pal-77302316b',
    icon: 'akar-icons:linkedin-fill',
  },
];

export const HERO_TITLES = ['Pranjul Pal', 'Full-stack Engineer', 'AI Enthusiast', 'Frontend Developer', 'Backend Developer'];
...
export const contactEmail = 'pranjulit@gmail.com';
